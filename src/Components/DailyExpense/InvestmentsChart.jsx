...
export default function InvestmentsChart(props) {
  ...
  useEffect(() => {
    ...
    if (response) {
      ...
      for (const category in response.monthlyexpenses) {
        ...
        if(category!=='budget')
        {
          ...
          for (const year in response.monthlyexpenses[category]) {
            for (const month in response.monthlyexpenses[category][year]) {
              for (const investmentId in response.monthlyexpenses[category][year][
                month
              ]) {
                const investment =
                  response.monthlyexpenses[category][year][month][investmentId];
