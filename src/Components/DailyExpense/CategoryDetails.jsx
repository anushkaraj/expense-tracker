...
function CategoryDetailsDailyExpense() {
  ...
  return (
    <div>
      {Object.keys(data).map(
        (category) =>
          category != "budget" &&
          Object.keys(data[category]).map((year) =>
            Object.keys(data[category][year]).map((month) =>
              Object.keys(data[category][year][month]).map((investmentKey) => {
                const investment = data[category][year][month][investmentKey];
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      handleDeleteFunction(investment);
                    }}
                  >
                    <img
                     className="image"
...
export default CategoryDetailsDailyExpense;
